...
export const ELK_NODE_NODE_SPACING = 80
/** input 较多时允许缩至的最小 nodeNode 间距 */
export const ELK_NODE_NODE_SPACING_MIN = 24
/** 超过该 input 数量后开始缩小间距 */
export const INPUT_COMPACT_SPACING_THRESHOLD = 6
/** 每多一个 input 缩小的 nodeNode 间距 */
export const INPUT_COMPACT_SPACING_STEP = 4
