...
public final class HardPressboardDtos {
  private HardPressboardDtos() {}
  ...
  public static class ItemResponse {
    ...
    public static ItemResponse from(HardPressboardListItem item) {
  ...
  public static class SaveItemRequest {
    @NotBlank(message = "硬压板引用不能为空")
    private String pressboardRef;
    @NotNull(message = "硬压板基准状态不能为空")
    private Boolean baselineValue;
