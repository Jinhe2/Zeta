...
/**
 * 统一引擎页面：路由 key + diagram key 保证切换版本时完整重挂载与重算
 */
export default function DiagramEnginePage({ engineId }) {
  ...
  const diagramKey = `${engine.id}-${configRevision}-${selectedSample || 'upload'}`
